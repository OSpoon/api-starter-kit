...
const workbenchChildren: RouteRecordRaw[] = [...workbenchRootRoute.children]
if (import.meta.env?.DEV === true) {
  workbenchChildren.push(...developmentWorkbenchRoutes)
}

export const workbenchRoutes: RouteRecordRaw[] = [
  { ...workbenchRootRoute, children: workbenchChildren },
]
