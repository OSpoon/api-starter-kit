  ...
  .group(() => {
    router
      .group(() => {
        ...
        router.post('github/complete', [GithubOauthController, 'complete']).as('github.complete')
    ...
    router
      .group(() => {
        ...
        router.post('github/unlink', [controllers.Profile, 'unlinkGithub']).as('github.unlink')
