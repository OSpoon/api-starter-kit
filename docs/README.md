...
文档按二次开发者的工作顺序组织。项目定位和能力概览见根目录 [README.md](../README.md)。

## 开始使用

- [快速开始](getting-started.md)：环境要求、依赖安装、基础环境变量和本地服务。
- [开发指南](customization.md)：如何替换 starter 示例、添加业务 feature、页面、API 和权限。
- [系统架构](architecture.md)：前后端分层、系统能力边界和 AI 扩展边界。

## 开发与接口

- [工程参考](development.md)：monorepo 结构、常用命令、实现入口和提交前检查。
